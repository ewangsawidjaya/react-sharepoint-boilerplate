		...
		return (
			<nav className="Navigation">
			    <ul className="nav-items">
					...
					<li className="nav-item"><NavLink activeClassName='is-active' to="/item-table">Item Table</NavLink></li>
					<li className="nav-item"><NavLink activeClassName='is-active' to="/image-editor">Image Editor</NavLink></li>
					<li className="nav-item"><NavLink activeClassName='is-active' to="/filter-table">Filter Table</NavLink></li>
			    </ul>
