...
export const ItemTableView = Loadable({
    loader: () => import(/* webpackChunkName: "ItemTable" */ './views/item-table-view'),
    loading() {
        return <span></span>
    }
});

export const ImageEditorView = Loadable({
    loader: () => import(/* webpackChunkName: "ImageEditor" */ './views/image-editor-view'),
    loading() {
        return <span></span>
    }
});

export const FilterTableView = Loadable({
    loader: () => import(/* webpackChunkName: "FilterTable" */ './views/filter-table-view'),
    loading() {
        return <span></span>
    }
});